          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="main.php?page=orderform">Server Status</a></li>
               ...
               <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="main.php?page=orderform">Create New User</a></li>
                  <li><a href="#">Change User Password</a></li>
                  <li><a href="#">Manage Access Level</a></li>
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Trevin Landers</span></li>
